    ...
    return (
        ...
        >
            ...
            <div className='work_item'>
                ...
                <span>Февраль 2023 - по настоящее время</span>
            ...
            <div className='work_item'>
                <h3>Иной опыт</h3>
                <p>Последние 5 лет работал в ресторанной сфере.В основном на позиции бармена.Работал за контактной стойкой,переодически заменял менеджеров,занимался закупками.</p>
            </div>
        </motion.section>
    )
}
